...
class CreateLandingPagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create("landing_pages", function (Blueprint $table) {
            ...
            $table->string("testimonial_sidecard")->nullable();

            $table->string("testimonial1_image")->nullable();
            $table->string("testimonial1_student_name")->nullable();
            $table->string("testimonial1_occupation")->nullable();
            $table->text("testimonial1_paragraph")->nullable();

            $table->string("testimonial2_image")->nullable();
            $table->string("testimonial2_student_name")->nullable();
            $table->string("testimonial2_occupation")->nullable();
            $table->text("testimonial2_paragraph")->nullable();
